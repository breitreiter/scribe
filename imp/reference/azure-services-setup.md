---
kind: reference
title: Azure Services Setup Guide
created: 2025-11-08
updated: 2026-05-15
urls:
...
**Note**: Azure OpenAI requires application approval. If you haven't been approved yet, apply at https://aka.ms/oai/access. Approval typically takes 1-2 business days.
...
2. Run with a small test audio file: `dotnet run -- /path/to/test-audio.mp3`
3. Watch for configuration validation, transcription start/complete, speaker diarization
...
2. **Rotate keys periodically** — Azure Portal → Your resource → Keys → Regenerate
3. **Use Managed Identities in production** — See: https://learn.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/
